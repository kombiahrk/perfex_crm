    ...
    <div class="col-lg-12">
        <div class="form-horizontal">
            ...
            <div class="saas_mysql" style="display: <?= ($saas_server == 'mysql_root_access' ? 'block' : 'none'); ?>">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label"><?= _l('database_prefix') ?>
                        <a href="https://docs.coderitems.com/perfectsaas/#mysql_database_prefix"
                           target="_blank"
                           data-toggle="tooltip"
                           data-title="<?= _l('database_prefix_help') ?>">
                            <i class="fa fa-question-circle"></i>
                        </a>
                    </label>
                    <div class="col-lg-6">
                        <input type="text" name="settings[saas_mysql_database_prefix]"
                               placeholder="<?= _l('database_prefix_placeholder') ?>"
                               value="<?php echo get_option('saas_mysql_database_prefix') ?>" class="form-control">
                    </div>
                </div>
